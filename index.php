...
<link rel="stylesheet" type="text/css" href="http:/enis/css/login.css">
...
<div id="login">
	<form action="" method="post">
		...
		<input name="submit" type="submit" value=" Login ">
			<a href="/enis/register.php" id="register">Registrieren</a>
...
<p3><i>19.03.2016</i></p>
<p>Willkommen auf meiner Seite, welche nur für die private Nutzung gedacht ist.<br/> Dennoch wünsche ich Verbesserungsvorschläge und Feedback.<br/><br/>Unter der Menüleiste 'Programme' könnt ihr euch ein, selbst mit Hilfe programmiertes<br/> Telefonbuch von mir herunterladen und diesen testen, so weit, wie er fertig ist.<br/><br/>Ihr könnt natürlich auch durch alle Menüleisten durchschauen um mehr über mich<br/> zu erfahren.<br/><br/>Mit freundlichen Grüßen<br/><br/>Enis Gedikli </p></div></div></div>
